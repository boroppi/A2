...
{
    public class DieselEngine : IInternalCombustion
    {
        ...
        ///<summary>
        /// This method returns True or False randomly
        ///</summary>
        public bool GlowPlugPower
        {
            get { return _rand.Next(2) != 0; }
            private set { }
        }

        public DieselEngine(Enum fuelType, double averageFuelRatePerSecond,
            int maximumPowerOutput, int cylinders, int displacement, IVehicle vehicle = null, bool running = false)
        {
            FuelType = fuelType;
            Running = running;
