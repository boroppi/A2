...
{
    public class ElectricMotor : IPowerPlant
    {
        ...
        public ElectricMotor(Enum fuelType, double averageFuelRatePerSecond, int maximumPowerOutput, bool running = false, IVehicle vehicle = null)
        {
            FuelType = fuelType;
            Running = running;
